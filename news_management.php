  ...
  *∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞∞*/
  function get_list() 
  {
    ...
    if($_REQUEST['Title']!=null){
      $sql_where.=" and Title like '%".$_REQUEST['Title']."%'";
    }
    ...
    foreach ($rec as $key => $value) {
      $sql_img = "select * from upload_file where Type = 7 and ID_Mater = ".$value["ID"];
